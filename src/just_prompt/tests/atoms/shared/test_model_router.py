...
import pytest
import os
# DEMO CODE REMOVED: from unittest.mock import patch, MagicMock
import importlib
...
# DEMO CODE REMOVED: def test_route_prompt(mock_import_module):
    """Test routing prompts to the appropriate provider."""
# DEMO CODE REMOVED: # Set up mock
# DEMO CODE REMOVED: mock_module = MagicMock()
# DEMO CODE REMOVED: mock_module.prompt.return_value = "Paris is the capital of France."
# DEMO CODE REMOVED: mock_import_module.return_value = mock_module
    
    # Test with full provider name
    response = ModelRouter.route_prompt("openai:gpt-4o-mini", "What is the capital of France?")
    assert response == "Paris is the capital of France."
# DEMO CODE REMOVED: mock_import_module.assert_called_with("just_prompt.atoms.llm_providers.openai")
# DEMO CODE REMOVED: mock_module.prompt.assert_called_with("What is the capital of France?", "gpt-4o-mini")
...
@patch('importlib.import_module')
# DEMO CODE REMOVED: def test_route_list_models(mock_import_module):
    """Test routing list_models requests to the appropriate provider."""
# DEMO CODE REMOVED: # Set up mock
# DEMO CODE REMOVED: mock_module = MagicMock()
# DEMO CODE REMOVED: mock_module.list_models.return_value = ["model1", "model2"]
# DEMO CODE REMOVED: mock_import_module.return_value = mock_module
...
# DEMO CODE REMOVED: mock_import_module.assert_called_with("just_prompt.atoms.llm_providers.openai")
# DEMO CODE REMOVED: mock_module.list_models.assert_called_once()
